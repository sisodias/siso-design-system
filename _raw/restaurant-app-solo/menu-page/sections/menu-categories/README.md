# MenuCategories Section Architecture

Scaffolded with `pnpm scaffold:section menu menu-categories`. Update the generated files to match the section's data contract and UI.
