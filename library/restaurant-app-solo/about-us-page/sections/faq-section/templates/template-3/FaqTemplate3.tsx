...
export default function FaqTemplate3(props: FaqContent) {
    ...
    <section className="flex min-h-[30vh] flex-col items-center justify-center bg-muted/20 px-6 text-center">
      <div className="max-w-2xl space-y-3">
        ...
        <p className="text-sm leading-relaxed text-muted-foreground/80">
          {description ??
            'No UI ships with this variant yet. Replace it with the approved FAQ component when design artifacts arrive.'}
        </p>
      </div>
    </section>
  );
