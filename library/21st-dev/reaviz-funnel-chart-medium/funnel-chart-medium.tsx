...
const simpleFunnelDataRaw: FunnelDataPoint[] = [
  ...
  { key: 'Resolved by Tier 1', data: 150 },
  { key: 'Resolved by Tier 2', data: 75 },
  { key: 'Closed', data: 200 }, // Sum of resolved can be tricky, ensure data reflects actual flow
];
...
// Adjusted color scheme for better differentiation in a multi-step funnel
const funnelChartColors = [
  '#5B14C5', // All Events
  '#6E28D9', // Alerts Triggered
  '#8B5CF6', // Incidents Created
  '#A78BFA', // Escalated
  '#C4B5FD', // Resolved by Tier 1
  '#DDD6FE', // Resolved by Tier 2
  '#EDE9FE', // Closed
];
...
interface DetailedFunnelReportCardProps {
  title?: string;
}

function DetailedFunnelReportCard({ title = "Incident Report" }: DetailedFunnelReportCardProps): JSX.Element {
  return (
              ...
              arc={
                <FunnelArc
                  ...
                  glow={{
                    ...
                    color: 'rgba(91, 20, 197, 0.6)', // Glow color with opacity
                  }}
                />
              }
              axis={
...
export default DetailedFunnelReportCard;