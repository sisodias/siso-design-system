...
export function Component({ fullGlobe = false, className }: ComponentProps) {
   return (
      <div
         className={cn(
            ...
            style={
               {
                  ...
                  "--line-color-1": "hsl(var(--primary))",
                  "--line-color-2": "hsl(var(--secondary))",
                  "--line-color-3": "hsl(var(--accent))",
               ...
               >
                  ...
                  >
                     <circle
                        cx="400"
                        cy="400"
                        fill="var(--ds-background-200, transparent)"
                        r="400"
                     />
                     <path
