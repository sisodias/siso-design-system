...
interface MetricInfo {
  ...
  delay: number;
  iconFillColor?: string; // Optional fill for the main icon
}
...
const initialMultiDateData: ChartSeries[] = [
  // Order matches LEGEND_ITEMS and CHART_COLOR_SCHEME
...
const METRICS_DATA: MetricInfo[] = [
  ...
  },
  {
    ...
    value: '10%',
    TrendIcon: TrendDownIcon, // Assuming lower is better for escalation rate, hence green trend
    trendBaseColor: '#40E5D1',
    trendStrokeColor: '#40E5D1',
    delay: 0.1,
    iconFillColor: '#E84045', // Icon itself is still red/alert
  },
];

const DetailedStackedIncidentReportCard: React.FC = () => {
  return (
    <>
      <style jsx global>{`
        :root {
      ...
      <div className="flex flex-col pt-4 pb-4 bg-white dark:bg-black rounded-3xl shadow-[11px_21px_3px_rgba(0,0,0,0.06),14px_27px_7px_rgba(0,0,0,0.10),19px_38px_14px_rgba(0,0,0,0.13),27px_54px_27px_rgba(0,0,0,0.16),39px_78px_50px_rgba(0,0,0,0.20),55px_110px_86px_rgba(0,0,0,0.26)] w-full max-w-md min-h-[580px] overflow-hidden transition-colors duration-300">
        ...
        <div className="reaviz-chart-container h-[200px] px-2">
          <StackedAreaChart
            height={200}
            id="stacked-incident-details-chart"
...
export default DetailedStackedIncidentReportCard;