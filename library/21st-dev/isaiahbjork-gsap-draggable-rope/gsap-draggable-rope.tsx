...
export function DraggableRope({ 
  ...
  return (
    <div
      className={cn(
        "flex flex-col items-center justify-center min-h-screen text-white font-['Helvetica_Neue',Helvetica,sans-serif]",
        className
      )}
    >
      <div
