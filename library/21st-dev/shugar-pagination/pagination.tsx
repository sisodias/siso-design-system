...
export const Pagination = ({ next, previous, children }: PaginationProps) => {
  return (
    <nav aria-label="pagination" className="flex justify-between items-center gap-1">
      ...
      {next && (
        <a href={next.href} className="rounded-md ml-auto py-1 pl-2 pr-7 !no-underline font-sans text-gray-900 hover:text-gray-1000 fill-gray-900 hover:fill-gray-1000 duration-150">
