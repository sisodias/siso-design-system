  ...
  return (
    <div className="pointer-events-none absolute top-0 bottom-0 left-0">
      {Array.from({ length: level }, (_, index) => {
        ...
        return (
          <div
            className="absolute top-0 bottom-0 border-neutral-800 border-l"
            key={index.toString()}
            style={{
      ...
      <div
        className="absolute top-1/2 border-neutral-800 border-t"
        style={{
      ...
      {isLast && (
        <div
          className="absolute top-0 border-neutral-800 border-l"
          style={{
            left: (level - 1) * (indent ?? 0) + 12,
            height: '50%',
          }}
...
export const TreeIcon = ({
  ...
  return (
    <motion.div
      className={cn(
        'mr-2 flex h-4 w-4 items-center justify-center text-neutral-400',
        className
      )}
