...
**Project root:** `/Users/shaansisodia/SISO_Workspace/SISO_Knowledge/design-system`
...
- Manifest file path: `/Users/shaansisodia/SISO_Workspace/SISO_Knowledge/design-system/library/manifest.json` — all other workers read this path via `getManifest()`; no worker ever imports the raw JSON.
...
**Worker prompt:**
> You are a Haiku worker. Working directory: `/Users/shaansisodia/SISO_Workspace/SISO_Knowledge/design-system`. Your isolated worktree is already created.
>
...
**Worker prompt:**
> You are a Sonnet worker. Working directory: `/Users/shaansisodia/SISO_Workspace/SISO_Knowledge/design-system`. Your isolated worktree is already created.
>
